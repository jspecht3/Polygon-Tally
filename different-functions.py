...
path = "output/different-functions/"
...
functions = [constant, parabolic, skewed_parabolic, saddle, cos, fast_cos]
...
for function in functions:
    func_name = (str(function)).split("function ")[1].split(" at")[0]
    loc_path = path + func_name + "/"
